...
_(none — M1 fan-out integrated 2026-08-20)_
...
files and no merge conflicted. Injecting  was what made
T-M1-4 independent of T-M1-1 — without it the two would have serialized.
The one gap the split created: T-M1-3 found that  has no way
